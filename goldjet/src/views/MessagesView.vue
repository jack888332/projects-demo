...
<template><div class="module-view"><PageHeader title="消息通知" description="已接入合作方提交、审批和授信事件；均为本地模拟，没有发送至企业微信或邮件系统" /><BusinessMessages :messages="messages" /></div></template>
