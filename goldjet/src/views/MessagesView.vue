...
<template><div class="module-view"><PageHeader title="消息通知" description="合作方、授信、空运建单、订舱及报价修改通知；均为本地模拟，没有发送至企业微信或邮件系统" /><BusinessMessages :messages="messages" /></div></template>
